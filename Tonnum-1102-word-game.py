...
def game_loop(secret_word):
    ...
    * After each round, you should also display to the user the 
    ...
    while guesses > 0 and game_end == False:
        ...
        if score_subtract == False:
            guesses -= 1
        print('')
        game_end = is_word_guessed(secret_word, letters_guessed)
